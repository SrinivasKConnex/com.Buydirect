...
public class CDWBankingDeclinePageTest extends TestBase {
	...
	public void beforeClass(ITestContext context) {
		...
		parentTest = ListenersImplementation.getReport().createTest("CDW Declined message Page Test");
		chaildTest = parentTest.createNode("=>Pre-required Action To Reach CDW Declined message Page");
		...
		chaildTest1 = chaildTest.createNode("=>Waiting for CDW Declined message Page Appear..");
		ExtentFactory.getInstance().setExtent(chaildTest1);
		CDW_ABA_DDA_Page.completeCDWPending(true);
		System.out.println("INFO: Waiting for CDW Declined message Page to appear.");
		chaildTest1 = chaildTest.createNode("=>Waiting for CDW Declined message Page Appear..");
		ExtentFactory.getInstance().setExtent(chaildTest1);
		CDWBankingDeclinePageObject.WaitErrorMessage();
		System.out.println("INFO: Waiting for CDW Declined message Page appear.");
	}

	@AfterClass
	public void afterClass() {
		System.out.println("\n=>The test on the CDW Declined message Page has been completed.");
		System.out.println("******************************");
	}
	...
	@Test
	public void Test_CDWDeclinedRedBoxErrorMessage() {
		try {
